...
<p class="lead text-center">Login to your administrator panel</p>
<div class="container">
    <div class="row">
        <div class="col-md-2">
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <form id="admin_login_form" class="admin_login_token" novalidate>
                <input type="hidden" id="admin_login_csrf_value" name="<?=$csrf['name'];?>" value="<?=$csrf['hash'];?>" />
                <div class="form-group">
                    ...
                    <small id="mobile_number_help" class="form-text text-muted">We'll verify the mobile number and then you can login as administrator</small>
                </div>
                <div class="form-group">
                    <input type="submit" id="admin_send_verification_code" class="btn btn-primary col-md-6" value="Submit">
                </div>
            </form>
        </div>
    ...
    <div class="row">
        <div class="col-md-2"></div>
        <div class="col-md-8">
            <form id="verify_admin_number_form" class="verify_number keep-hidden" novalidate>
